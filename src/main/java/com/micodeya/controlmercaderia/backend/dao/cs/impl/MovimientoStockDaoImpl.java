...
public class MovimientoStockDaoImpl extends GenericDAO<MovimientoStock, Integer> implements MovimientoStockDao {
    ...
    public MovimientoStockDaoImpl() {
        ...
        atributosDefault = "infoAuditoria,zkUltimaModificacionMask,idMovimientoStock,producto.idProducto,producto.producto,cantidadMovimiento,tipoMovimiento,usuario.idUtilizador,usuario.usuario";
