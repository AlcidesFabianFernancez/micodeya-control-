package com.micodeya.controlmercaderia.backend;
...
@ComponentScan(basePackages = {"zzz.com.micodeya.backend.core", "com.micodeya.controlmercaderia.backend"})
@EntityScan(basePackages = {"zzz.com.micodeya.backend.core", "com.micodeya.controlmercaderia.backend"})
@EnableJpaRepositories(basePackages = {"zzz.com.micodeya.backend.core", "com.micodeya.controlmercaderia.backend"})
public class ControlmercaderiaApplication {

	public static void main(String[] args) {
		SpringApplication.run(ControlmercaderiaApplication.class, args);
	}
	...
	public void doSomethingAfterStartup() {
        ...
        try (InputStream is = ControlmercaderiaApplication.class.getResourceAsStream("/META-INF/MANIFEST.MF")) {
