...
public class PedidosRest {
    ...
    private final String BASE_API = "/api/cs/pedidos";
    ...
    private void transformacionAdicional(InfoAuditoria infoAuditoria, Pedidos pedidos) {
    ...
    public Map<String, Object> listar(
        ...
        JeResponse jeResponse=new JeResponse("Listado correcto de Pedidos","Error grave al listar Pedidos");
        ...
        try {
            ...
            if (jeResponse.sinErrorValidacion()) {
                jeResponse.putResultadoListar(pedidosDao.listarAtributosPorPagina(new Pedidos(cuentaCore), paginacionAux.getAtributos(), paginacionAux));
            }
    ...
    public Map<String, Object> agregar(
        ...
        JeResponse jeResponse=new JeResponse("Pedidos creado correctamente","Error grave al crear Pedidos");
        UsuarioSesionInterno userSession = null;
        ...
        try {
            ...
            transformacionBasica(userSession.getInfoAuditoria(), pedidos);
            /** VERIFICACION BASICA */
            jeResponse.addErrorValidacion(pedidosDao.verificacionBasica(userSession.getInfoAuditoria(), pedidos));
            ...
            if (jeResponse.sinErrorValidacion()) {
                pedidosDao.agregar(userSession.getInfoAuditoria(), pedidos);
                jeResponse.putResultado("idPedidos", pedidos.getIdPedidos());
            }
    ...
    public Map<String, Object> modificar(
        ...
        JeResponse jeResponse=new JeResponse("Pedidos modificado correctamente","Error grave al modificar Pedidos");
        UsuarioSesionInterno userSession = null;
        ...
        try {
            ...
            transformacionBasica(userSession.getInfoAuditoria(), pedidos);
            /** VERIFICACION BASICA */
            if(pedidos.getIdPedidos()==null) jeResponse.addErrorValidacion("Pedidos sin id para modificar");
            jeResponse.addErrorValidacion(pedidosDao.verificacionBasica(userSession.getInfoAuditoria(), pedidos));
            ...
            if (jeResponse.sinErrorValidacion()) {
                pedidosDao.modificar(userSession.getInfoAuditoria(), pedidos);
                jeResponse.putResultado("idPedidos", pedidos.getIdPedidos());
            }
    ...
    public Map<String, Object> eliminar(
        ...
        JeResponse jeResponse=new JeResponse("Pedidos eliminado correctamente","Error grave al elimimar Pedidos");
        UsuarioSesionInterno userSession = null;
        ...
        try {
            ...
            if (jeResponse.sinErrorValidacion()) {
                pedidosDao.eliminarPorId(userSession.getInfoAuditoria(), pedidos.getIdPedidos());
                jeResponse.putResultado("idPedidos", pedidos.getIdPedidos());
            }
    ...
    private void transformacionBasica(InfoAuditoria infoAuditoria, Pedidos pedidos) throws JsonMappingException, JsonProcessingException {
        boolean modificar = pedidos.getIdPedidos() != null;

		pedidos.setFechaPedido(JeBoot.getFecha(pedidos.getFechaPedidoMask()));
		pedidos.setFechaEntrega(JeBoot.getFecha(pedidos.getFechaEntregaMask()));

        transformacionAdicional(infoAuditoria, pedidos);
