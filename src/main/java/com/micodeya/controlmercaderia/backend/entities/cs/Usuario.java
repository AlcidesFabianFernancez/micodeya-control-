...
@SQLDelete(sql = "UPDATE CS_USUARIO SET zk_eliminado = true, zk_fec_elim= now() WHERE id_usuario=?")
...
public class Usuario extends AbstractModelZk implements Serializable{
	...
	@SequenceGenerator(name = "generator", sequenceName = "cs_usuario_seq", allocationSize = 1)
